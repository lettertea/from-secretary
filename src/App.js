...
function App() {
    return (
        <Typography className="App">
        	...
        	<p>In contrast, there are more lax stopping rules like 25% and √N (N being the pool size). The chosen candidate will be worse on average, but there's less chance of failing and the candidate will be found earlier.</p>
        	...
        	</Link>), it resembles a normal distribution, or a bell curve, where most people score near the average and very few in the outlier ranges. I believe this phenomenon occurs because the requirements to score near the mean are very flexible and include many candidates. Someone can be talented at SAT tests, take it sleep deprived, and score somewhere in the middle. Someone could be naturally bad at SAT tests, do a good amount of prep, then score near the middle again. There isn't a particular description you have to fit to score near the mean since many are acceptable.</p>
<p>But to score at the extreme outlier ranges, there isn't much leeway. You can't be naturally bad at taking SAT tests and can't be uninterested in doing well. You can't just take it once, and you can't be bad at a single SAT topic. You have to have it all—or be extremely exceptional in some aspects to make up for the others. Only those who can match that limited and brutal description with minimal mistakes can achieve outlier scores.</p>
<p>Looking at dice rolls can be a good analogy to give a different perspective. If we roll a single die enough times, we will get a uniform distribution of results. With two dice, it will look like a triangle because there are more ways to achieve the mean, 7, than an outlier like 2. And when we keep adding more dice, the graph quickly begins to resemble a normal distribution. There are far more combinations of rolls that achieve the middle than the ends.</p>
...
<p>The chart earlier is based on a perfect representation of all the SAT test takers in 2015. Sample bias is extremely common–even if we’re trying to avoid it. Our particular distribution may be very different from the actual global distribution. A candidate may be 99.03 percentile in our pool, but if that distribution is relatively poor in SAT performance, that “99.03 percentile candidate” may be just a 70 percentile candidate globally.</p>
...
<p>One surprising thing to me is that the blue (non-local) distribution yields qualified candidates far more quickly than the yellow (local) distribution despite having a slightly (arguably) higher mean. At 50% probability, it takes 15 non-local students to find a candidate who scored at least a 1400 compared to 76 for local students. My takeaway is that even a small change in behavior when picking candidates can make a large difference. And a larger change in behavior, such as evaluating candidates from Harvard for SAT scores, can make an unimaginable difference.</p>
<h1>Other considerations</h1>
<h3>Picking poorer performing population</h3>
<p>It’s sometimes preferable to pick a poorer performing population. Sometimes candidates have a will of their own and can reject the evaluator, and poorer performing populations may not reject as often. Sometimes it’s less expensive in terms of costs, speed, effort, etc., to evaluate candidates in poorer-performing populations too, making it much easier to evaluate a large number of candidates to find outliers.</p>
<h3>Number of candidates to evaluate</h3>
<p>Diverse normal distributions (large standard deviations or wide bell curves) have outliers that perform much better than mean performers (like CSULB for SAT) compared to relatively homogeneous distributions (like Harvard for SAT). For those diverse populations, it is more beneficial to evaluate a larger number of candidates to find those outliers.</p>
<h1>Motivation</h1>
<p>I find that there’s immense pressure to seek the best out there, whether a partner, job, house, or Node package for that obscure React app no one will look at. But it can be for a good reason. Many of these decisions can have huge impacts in our lives, and putting the effort and patience in making the right decision can be absolutely worth it.</p> 
<p>Yes, It can be time consuming, frustrating, and stressful. It’s difficult, and I feel like many people give up and settle due to fatigue and overload of decisions. That’s why I think it’s important to approach these things strategically before playing the “number’s game.”</p>
<p>So this article is just my perspective on dealing with this issue. I tend to write things out when I need to think.</p>
