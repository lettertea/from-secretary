...
export default props => {
    ...
    return (
        <div>
            ...
            <Typography variant={"caption"}>Likeliness the best candidate will score equal to or better than particular
                benchmark scores after {SIMULATIONS} simulations</Typography>
        </div>
    )
}